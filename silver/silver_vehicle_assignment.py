...
SILVER_PATH      = "s3://omniroute-silver/poc-bootcamp-group1-silver/vehicle_assignment/"
...
def main():
    ...
    try:
        ...
        dyf = glue_context.create_dynamic_frame.from_options(
            ...
            transformation_ctx="vehicle_assignment_source"
        )
        
        df = dyf.toDF()

        if df.isEmpty():
            log.info("No new vehicle_assignment files found by bookmark. Exiting.")
            success = True
            return
