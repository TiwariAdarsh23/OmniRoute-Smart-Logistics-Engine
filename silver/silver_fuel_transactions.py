...
SILVER_PATH      = "s3://omniroute-silver/poc-bootcamp-group1-silver/fuel_transactions/"
...
def main():
    ...
    try:
        dyf = glue_context.create_dynamic_frame.from_options(
            ...
            transformation_ctx="fuel_transactions_source"
        )
        ...
        if df.isEmpty():
            log.info("No new files found by bookmark. Exiting.")
            success = True
            return
        ...
        final_df = dyf_clean.toDF().repartition(40)
