...
SILVER_PATH = "s3://omniroute-silver/poc-bootcamp-group1-silver/vehicle_registry/"
...
def main(): 
    ...
    try: 
        dyf = glue_context.create_dynamic_frame.from_options(
            ...
            transformation_ctx="vehicle_registry_source"
        )
        ...
        df_clean_write = dyf_clean.toDF().repartition(40, "model")
        ...
        log.error(f"Unexpected failure processing {BRONZE_PREFIX}/vehicle_registry_{logical_date}.csv : {e}")
