...
pg_url = "jdbc:postgresql://3.109.220.115:5432/report"
...
SILVER_FUEL_TRANSACTIONS = "s3://omniroute-silver/poc-bootcamp-group1-silver/fuel_transactions/"
SILVER_VEHICLE_REGISTRY = "s3://omniroute-silver/poc-bootcamp-group1-silver/vehicle_registry/"
SILVER_MAINTENANCE_SCHEDULES = "s3://omniroute-silver/poc-bootcamp-group1-silver/maintenance_schedules/"

GOLD_FUEL_EFFICIENCY_AUDIT = "s3://omniroute-gold/poc-bootcamp-group1-gold/fuel_efficiency_audit/"
...
def main():
    ...
    try:
        ...
        if audit_df.isEmpty():
            log.info("Audit DataFrame is empty. Skipping PostgreSQL write.")
        else:
